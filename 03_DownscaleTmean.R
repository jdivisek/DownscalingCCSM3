###DOWNSCALE MONTHLY MEAN TEMPERATURE-------------------------------------------------------------
...
for(i in seq(1, length(ch.paths)))
{
  ...
  writeRaster(ch.agr, paste0(getwd(), "/GIS_database/CHELSA_upscaled/tmean/tmean", n[i], "avg.tif"), "GTiff")
...
m1965.paths <- c(paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/01_Jan/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/02_Feb/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/03_Mar/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/04_Apr/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/05_May/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/06_Jun/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/07_Jul/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/08_Aug/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/09_Sep/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/10_Oct/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/11_Nov/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmean/1940-1989/12_Dec/grid_data_1965AD.txt"))

o1965.paths <- list.files(path= paste0(getwd(), "/GIS_database/CHELSA_upscaled/tmean"), pattern='tif', full.names=TRUE)
...
for(i in 1:12)
{
  ...
  writeRaster(bias, paste0(getwd(), "/GIS_database/bias_files/", "bias_tmean", n[i], ".tif"), "GTiff")
}
...
ch.paths <- list.files(path= paste0(getwd(), "/GIS_database/CHELSA 1940-1989/interpolated/tmean"), pattern='sgrd', full.names=TRUE)

#create target directories
for(q in seq(1, 12))
{
  dir.create(path = paste0(getwd(), "/GIS_database/Paleoclimates_CCSM3/SAGA/tmean/", 
                           n[q], "_", month.abb[q]))
}
...
for(q in 1:12)##loop for 12 months
{
  ...
  for(i in seq(1,length(m.paths[[q]]))) #loop for each time window over the last 21 000 years #
  {
    ...
    filename <- paste0(getwd(), "/GIS_database/Paleoclimates_CCSM3/SAGA/tmean/", 
                       n[q], "_", month.abb[q], "/tmean", n[q], "_", tw[i], "BP", ".tif")
