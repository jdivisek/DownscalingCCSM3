...
ch.paths <- list.files(path= paste0(getwd(), "/GIS_database/CHELSA 1940-1989/interpolated/tmin"), pattern='sdat', full.names=TRUE )
...
for(i in seq(1, length(ch.paths)))
{
  ...
  writeRaster(ch.agr, paste0(getwd(), "/GIS_database/CHELSA_upscaled/tmin/tmin", n[i], "avg.tif"), "GTiff")
...
m1965.paths <- c(paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/01_Jan/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/02_Feb/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/03_Mar/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/04_Apr/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/05_May/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/06_Jun/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/07_Jul/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/08_Aug/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/09_Sep/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/10_Oct/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/11_Nov/grid_data_1965AD.txt"),
                 paste0(getwd(), "/paleodata_months_Europe/tmin/1940-1989/12_Dec/grid_data_1965AD.txt"))

o1965.paths <- list.files(path= paste0(getwd(), "/GIS_database/CHELSA_upscaled/tmin", sep = ""), pattern='tif', full.names=TRUE)
...
for(i in 1:12)
{
  ...
  writeRaster(bias, paste0(getwd(), "/GIS_database/bias_files/", "bias_tmin", n[i], ".tif"), "GTiff")
}

bias <- stack(list.files(path= paste0(getwd(), "/GIS_database/bias_files/tmin", sep = ""), pattern='tif', full.names=TRUE))
projection(bias) <- CRS("+proj=longlat +datum=WGS84")
plot(bias, main=month.name)

###DEBIASING AND DOWSCALING CCSM3 SIMULATIONS--------------------------------------------------------------------
m.paths <- list()
m.paths[[1]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/01_Jan", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[2]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/02_Feb", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[3]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/03_Mar", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[4]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/04_Apr", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[5]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/05_May", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[6]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/06_Jun", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[7]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/07_Jul", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[8]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/08_Aug", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[9]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/09_Sep", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[10]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/10_Oct", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[11]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/11_Nov", sep = ""), pattern='txt', full.names=TRUE)
m.paths[[12]] <- list.files(path= paste0(getwd(), "/paleodata_months_Europe/tmin/12_Dec", sep = ""), pattern='txt', full.names=TRUE)
